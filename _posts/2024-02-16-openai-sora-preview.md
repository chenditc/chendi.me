...
在训练 Sora 时，数据集除了视频本身，还需要有**描述视频的文本**。对视频的描述越详细，模型就越容易捕捉到视频内的细节，但对视频进行细致的标注是很困难，也很昂贵的。于是 OpenAI 就选择了让 AI 来​帮助标注视频。
...
技术文档里还对 Sora 的能力边界进行了不同的测试，[在昨天的文章中可以直观地感受到。](https://mp.weixin.qq.com/s/Ufs7__JmBAIKDGVErA5pcg)
